...
func Create(args []string) error {
	...
	cleartext, res, err := shared.Descope.Management.AccessKey().Create(context.Background(), args[0], Flags.Description, Flags.Expires, nil, tenants, Flags.UserId, nil, nil, nil)
	if err != nil {
		return err
	}
